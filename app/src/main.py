...
class TestApp(VehicleApp):
    """Velocitas App for passengerwelcomedigitalgen."""
    ...
    async def reset(self):
        ...
        await self.Vehicle.Cabin.Seat.Row1.DriverSide.Height.set(0)
...
async def main():
    logger.info("Starting PassengerwelcomedigitalgenApp...")
    vehicle_app = PassengerwelcomedigitalgenApp(vehicle)
    await vehicle_app.run()
